...
def cached(timeout: int):
    ...
    def wrap1(class_or_method, *args):
        ...
        if inspect.isclass(class_or_method):
            ...
            cache_wrap.__cache_name__ = 'cache_wrap'
...
def process_resource(self, req, resp, resource, params):
    ...
    if req.get_header('cache-control', default=None) == 'no-cache':
        return    
    ...
    responder = None
    resource_attrs = dir(resource)
        
    for _method in resource_attrs:
    ...
    if responder:
        ...
        elif (responder_wrapper_name == 'cache_wrap' or responder_cache_wrapper_name is not None):
